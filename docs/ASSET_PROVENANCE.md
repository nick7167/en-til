...
Native character views now use transparent cutouts of the twelve approved reference characters. Final expression/pose and per-screen artwork review remains required. Generated art is an implementation candidate, not new user approval.
