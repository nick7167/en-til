...
import shutil
for name, source in {'lounge':'lounge','backing':'lounge','home':'home','question':'question','waiting':'waiting','ice':'ice-reference','lobby':'lobby','privateRound':'privateRound','finale':'finale','board':'board','adult':'home','settings':'board'}.items():
