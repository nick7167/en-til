/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=backend/wrangler.jsonc --strict-vars=false backend/worker-configuration.d.ts` (hash: 6b2236c6a817ab8f3ab7492f147ae1df)
...
interface __BaseEnv_Env {
	...
	ENVIRONMENT: string;
	DISABLED: string;
	ROOMS: DurableObjectNamespace<import("./src/worker").RoomObject>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DISABLED">> {}
}
